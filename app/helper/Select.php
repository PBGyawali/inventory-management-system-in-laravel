...
//helper class to create select inputs
	class Select {
        ...
        function category_list($value=null){
        ...
        function tax_list($value=null){
            return $this->list('tax',$value);
        }
        function unit_list($value=null){
            return $this->list('unit',$value,'name',);
        }

		// category is the table's singular name
	...
	{
		$html = '<select name="company_currency" id="company_currency" class="form-control" required>
    ...
    static function Timezone_list($value=null)
	{
		...
		$html = '<select name="company_timezone" id="company_timezone" class="form-control" required>
